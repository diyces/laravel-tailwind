...
<body class="bg-gray-900 min-h-screen flex flex-col">
    ...
    <nav class="bg-gray-800 text-white px-6 py-4 flex justify-between items-center">
        <h1 class="font-bold text-lg">Prawira Hadi Wijaya</h1>
    ...
    <h1 class="font-bold text-white text-center py-16 text-4xl">Selamat Datang Di Web Saya!</h1>
    <h2 class="font-bold text-center text-gray-600 mt-2">Saya seorang deveploper web fullstak</h2>

    <main class="flex-1 items-center justify-center px-50 py-16">
    <div class="group relative bg-white rounded-xl shadow-lg p-6
      ...
      <p class="text-gray-600 mt-2">
        Halo, saya seorang web deveploper fullstak. 
      </p>
...
<footer class="relative w-full mb-20 py-50">
  <div class="w-full px-8 mx-auto max-w-7xl">
    ...
    <div class="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
      <p class="block mb-4 text-sm text-center text-slate-500 md:mb-0">
        Copyright © 2024 
        <a href="<!--https://material-tailwind.com/-->">HadiDev</a>. All
        Rights Reserved.
      </p>
